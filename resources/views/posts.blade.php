...
{{ $posts->links() }}
        <div class="mt-4 grid gap-8 lg:grid-cols-3 md:grid-cols-2">
                ...
                <div class="flex justify-between items-center">
                    <a href="/posts?author={{ $post->author->username }}">
                        <div class="flex items-center space-x-4">
                            <img class="w-7 h-7 rounded-full" src="{{ $post->author->avatar ? asset('storage/' . $post->author->avatar) : asset('img/avatar_default.jpg') }}" alt="{{ $post->author->name }}" />
            ...
            @empty
            <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6 max-h-screen-xl my-auto flex justify-center items-center">
                <div class="text-center p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    <p class="font-semibold text-xl mb-4 text-gray-800 dark:text-white">
                        Article not found!
                    </p>
                    <a href="/posts" class="block text-blue-500 hover:underline">
