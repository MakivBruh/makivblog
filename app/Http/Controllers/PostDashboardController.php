...
class PostDashboardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), [
            ...
            'body.min' => ':attribute harus 20 karakter atau lebih'
        ...
        return redirect('/dashboard')->with(['success' => 'Post kamu sudah disimpan!']);
    }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        // Redirect
        return redirect('/dashboard')->with(['success' => 'Post kamu sudah dihapus!']);
    }
